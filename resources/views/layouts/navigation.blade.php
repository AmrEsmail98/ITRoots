    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard.alluser',app()->getLocale())" :active="request()->routeIs('dashboard.alluser')">
                        {{ __('All Users') }}
                    </x-nav-link>
                </div>
                @if(Auth::user()->hasRole('user'))
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard.myprofile',app()->getLocale())" :active="request()->routeIs('dashboard.myprofile')">
                        {{ __('My profile') }}
                    </x-nav-link>
                </div>
            </div>
